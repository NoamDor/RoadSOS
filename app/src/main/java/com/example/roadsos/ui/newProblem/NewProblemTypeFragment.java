...
public class NewProblemTypeFragment extends Fragment {

    RecyclerView list;
    List<ProblemType> data = new LinkedList<ProblemType>();
    ProblemTypesListAdpater adapter;
    Integer selectedViewPosition = -1;
    NewProblemTypeViewModel viewModel;
    LiveData<List<ProblemType>> liveData;
    View selectedView;

    public NewProblemTypeFragment() {
    }

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_new_problem_type, container, false);
        list = view.findViewById(R.id.new_problem_type_list);
        ...
        Button continueBtn = view.findViewById(R.id.new_problem_type_continue_btn);
...
//                    ProblemCreationFragmentDirections.actionProblemCreationFragmentToProblemDetailsFragment(data.get(selectedViewPosition));
            NavDirections direction2 = NewProblemTypeFragmentDirections.actionNewProblemTypeFragmentToNewProblemLocationFragment(data.get(selectedViewPosition));
    ...
    public void onAttach(@NonNull Context context) {
        ...
        viewModel = new ViewModelProvider(this).get(NewProblemTypeViewModel.class);
    }
